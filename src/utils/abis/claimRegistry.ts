const claimRegistryABI = [
	...
	{
		inputs: [{ internalType: 'address', name: 'withdrawalAddress', type: 'address' }],
		name: 'claim',
		outputs: [],
	...
	{
		inputs: [{ internalType: 'address[]', name: 'withdrawalAddresses', type: 'address[]' }],
		name: 'claimBatch',
		outputs: [],
		stateMutability: 'nonpayable',
		type: 'function',
	...
	},
	{
		...
		outputs: [{ internalType: 'contract ISBCDepositContract', name: '', type: 'address' }],
		stateMutability: 'view',
		type: 'function',
	},
	{
		inputs: [],
		name: 'getClaimableAddresses',
		outputs: [{ internalType: 'address[]', name: '', type: 'address[]' }],
		stateMutability: 'view',
		type: 'function',
	},
	...
	},
	{
		inputs: [
			...
			{ internalType: 'address', name: '_actionContract', type: 'address' },
		],
		name: 'register',
		outputs: [],
		stateMutability: 'nonpayable',
	...
	},
	{
		...
		name: 'setWhitelistedActionContract',
		outputs: [],
		stateMutability: 'nonpayable',
		type: 'function',
	},
	...
	{
		inputs: [{ internalType: 'address', name: '', type: 'address' }],
		name: 'whitelistedActionContracts',
		outputs: [{ internalType: 'bool', name: '', type: 'bool' }],
		stateMutability: 'view',
		type: 'function',
	},
