...
export default function Navbar() {
	return (
		<div className="navbar bg-base-200 border-base-content/20 sticky top-0 z-50 border-b px-4 shadow-xs sm:px-8">
			<div className={`text-secondary flex flex-1 items-center font-bold ${boldonse.className}`}>
				<svg
			...
			<div className="flex items-center gap-x-4">
				...
				<Link
					...
					className="hover:text-secondary/70 flex items-center gap-x-1 font-medium"
				>
